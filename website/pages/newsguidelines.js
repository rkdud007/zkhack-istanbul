...
export default function NewsGuidelines() {
    return (
        <div className="news-guidelines-wrapper">
            <HeadMetadata title="ZKHackerNews Guidelines" />
            ...
            <div className="news-guidelines-text-container">
                <p className="news-guidelines-text-title">ZKHackerNews Guidelines</p>
                ...
                <p>
                    Please don’t use ZKHackerNews for political or ideological battle. That destroys intellectual
                ...
                <p>
                    ...
                    ZKHackerNews is a community—users should have an identity that others can relate to.
                </p>
                <p>
                ...
                <p>
                    Please don’t submit comments saying that ZKHackerNews is turning into Reddit. It’s a semi-noob
